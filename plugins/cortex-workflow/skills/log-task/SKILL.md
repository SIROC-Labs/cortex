...
2. `resolve_board("backlog")` → the available backlog boards (the provider handles discovery, freshness, and caching internally — see `plugins/cortex-workflow/references/workflow/boards.md` for the active-sprint policy).
