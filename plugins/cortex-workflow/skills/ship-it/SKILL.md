...
1. **Move to "In Review":** `set_status(task, "In Review")` (per `plugins/cortex-workflow/references/workflow/lifecycle.md`). The seam resolves the board and target column — do not re-fetch board structure.
